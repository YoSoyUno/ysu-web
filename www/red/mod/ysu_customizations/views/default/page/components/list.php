 ...
 <?php
// YSU: agrega class al item segun tipo de evento
...
foreach ($items as $item) {
	...
	if ($item instanceof \ElggEntity) {
		...
		if ($subtype) {
			...
			// Agrega una clase segun el tipo de evento si esta definido

			if ($subtype == 'event' AND $item->event_type) {
				$event_type = str_replace(' ', '-', strtolower($item->event_type));
				$li_attrs['class'][] = "elgg-item-$type-$subtype-$event_type";
			}
