	...
	<div id="boxhome">
		...
		<form id="boxhome_form" class="elgg-form-file-upload" enctype="multipart/form-data" action="<?php echo elgg_get_site_url() ?>action/file/upload" method="post">
			...
			<div class="input_textarea  elgg-form-small" id="input_body">
				<textarea name="description" id="boxhome_description" class="elgg-input-longtext" cols="30" rows="2" placeholder="<?php echo elgg_echo('ysu:boxhome:description') ?>" data-max-length="140"></textarea>
			</div>
			...
			<input id="boxhome_save" class="elgg-button elgg-button-submit" type="submit" value="<?php echo elgg_echo('ysu:boxhome:compartir') ?>">
