 ...
 * @subpackage UI
 */
$topbar_background_color = elgg_get_plugin_setting('topbar_background_color', 'ysu_theme');
$topbar_a_color = elgg_get_plugin_setting('topbar_a_color', 'ysu_theme');
...
.elgg-filters-select-river select{
  background: url("<?php echo elgg_get_site_url();?>mod/ysu_theme/graphics/arrow-down-01-16.png") no-repeat scroll right center #fff;
  border: 0 solid #ccc;
  overflow: hidden;
  width: 100px;
  font-size: 80%;
