...
$activity .= '<img id="river_auto_update_loading" src="' . elgg_get_site_url() . '/mod/ysu_theme/graphics/loading.gif" height="25px;" style="display:none; margin-left:auto; margin-right:auto;">';
